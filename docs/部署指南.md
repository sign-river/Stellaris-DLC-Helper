...
本文件整合并替代了原英文 `DEPLOYMENT_GUIDE.md`，说明如何部署和验证 R2、GitHub、国内云与 Gitee 上的 DLC 文件。已将检查/上传步骤与常见故障排除合并并本地化。
...
2. 在 GitHub 上创建发布 `ste4.2`，上传 `001.zip`..`039.zip` 并更新 `pairings.json`。
3. 在 `domestic_cloud` 部署 `index.json` 与 DLC 文件，检查文件目录与权限。
